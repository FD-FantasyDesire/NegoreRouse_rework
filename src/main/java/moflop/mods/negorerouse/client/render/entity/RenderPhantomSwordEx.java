package moflop.mods.negorerouse.client.render.entity;

import moflop.mods.negorerouse.entity.EntityPhantomSwordEx;
...
public class RenderPhantomSwordEx extends Render<EntityPhantomSwordEx> {
    ...
    @Override
    public void doRender(EntityPhantomSwordEx entity, double d0, double d1, double d2, float f, float f1)
    {
        if (entity instanceof EntityPhantomSwordEx)
        {
            doDriveRender((EntityPhantomSwordEx) entity, d0, d1, d2, f, f1);
        }
    }

    @Override
    protected ResourceLocationRaw getEntityTexture(EntityPhantomSwordEx entity) {
        return null;
    }

    private void doDriveRender(EntityPhantomSwordEx entityPhantomSwordEx, double dX, double dY, double dZ, float f, float f1)
    {
        ...
        GL11.glRotatef(entityPhantomSwordEx.rotationYaw, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(-entityPhantomSwordEx.rotationPitch, 1.0F, 0.0F, 0.0F);
        GL11.glRotatef(entityPhantomSwordEx.getRoll(),0,0,1);
        ...
        //■スタート
        float lifetime = entityPhantomSwordEx.getLifeTime();
        float ticks = entityPhantomSwordEx.ticksExisted;
