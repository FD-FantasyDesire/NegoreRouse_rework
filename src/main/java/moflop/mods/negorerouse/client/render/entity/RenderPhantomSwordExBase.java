...
import moflop.mods.negorerouse.entity.EntityPhantomSwordExBase;
...
public class RenderPhantomSwordExBase extends Render {
    ...
    public RenderPhantomSwordExBase(RenderManager renderManager) {
        super(renderManager);
    }
    ...
    {
        if (entity instanceof EntityPhantomSwordExBase)
        {
            doDriveRender((EntityPhantomSwordExBase) entity, d0, d1, d2, f, f1);
        }
    }
    ...
    private void doDriveRender(EntityPhantomSwordExBase entity, double dX, double dY, double dZ, float f, float f1)
    {
        ...
        //f
        GL11.glRotatef(lerpDegrees(entity.prevRotationYaw, entity.rotationYaw, f1), 0.0F, 1.0F, 0.0F); //yaw
        GL11.glRotatef(-lerpDegrees(entity.prevRotationPitch, entity.rotationPitch, f1), 1.0F, 0.0F, 0.0F);
